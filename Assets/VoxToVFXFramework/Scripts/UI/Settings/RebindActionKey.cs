...
namespace VoxToVFXFramework.Scripts.UI.Settings
{
	...
	/// </summary>
	public class RebindActionKey : MonoBehaviour
	{
		/// <summary>
		...
		private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
		{
			...
			{
				m_BindingText.text = LocalizationKeys.SETTINGS_WAITING.Translate();
			}
		...
		protected void OnEnable()
		{
			if (s_RebindActionUIs == null)
				s_RebindActionUIs = new List<RebindActionKey>();
		...
		private static List<RebindActionKey> s_RebindActionUIs;
		...
		[Serializable]
		public class UpdateBindingUIEvent : UnityEvent<RebindActionKey, string, string, string>
		{
		}

		[Serializable]
		public class InteractiveRebindEvent : UnityEvent<RebindActionKey, InputActionRebindingExtensions.RebindingOperation>
		{
		}
	}
}
